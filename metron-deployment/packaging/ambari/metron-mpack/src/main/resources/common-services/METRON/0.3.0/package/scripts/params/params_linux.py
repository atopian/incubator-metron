...
es_keystore_path = config['configurations']['metron-env']['es_keystore_path']
es_keystore_password = config['configurations']['metron-env']['es_keystore_password']
es_truststore_path = config['configurations']['metron-env']['es_truststore_path']
es_truststore_password = config['configurations']['metron-env']['es_truststore_password']
